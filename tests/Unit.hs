    ...
    ~: [ "separate"
         ...
         "lineWrap"
           ~: utf8Test
             ...
             [ prompt 0,
               utf8 lwc1 <> wrap <> utf8 lwc2 <> wrap <> utf8 lwc3,
               cr <> "\ESC[2A\ESC[2C",
               cr <> nl <> nl <> "\ESC[22C"
             ]
       ]
...
incorrectInput i =
  "incorrect input"
    ~: [ utf8Test
           i
           [utf8 "x" <> raw [206]] -- needs one more byte
         ...
         utf8Test
           i
           [raw [236, 149] <> utf8 "x"] -- needs one more byte
  ...
  "getInputChar"
    ~: [ utf8Test
         ...
         "bad encoding (separate)"
           ~: utf8Test
             i
             [utf8 "α", raw [149], utf8 "x", raw [206]]
             [ prompt 0,
               utf8 "α" <> end <> output 0 (utf8 "α") <> prompt 1,
         ...
         utf8Test
           ...
           [raw [206]] -- incomplete
           [ prompt 0,
             whenLegacy (utf8 "?" <> end <> output 0 (utf8 "?"))
               <> whenLegacy (prompt 1)
           ]
       ]
...
fileStyleTests i =
  "file style"
    ~: [ "line input"
         ...
         "invalid char input (following a newline)"
           ~: utf8Test
             iFileChar
             [utf8 "a\n" <> raw [149] <> utf8 "x\n" <> raw [206]]
           $ [ prompt' 0,
